...
RSpec.describe Ability, type: :model do
  ...
  context 'admin' do
    it 'can manage objects' do
      [User, Actor, ActorMicro, ActorMeso, ActorMacro, ActorRelation, Action, ActionMicro, ActionMeso, ActionMacro, ActionRelation, Localization, Category].each do |model|
  ...
  context 'user' do
    it 'can manage objects' do
      ...
      [Actor, ActorMicro, ActorMeso, ActorMacro, ActorRelation, Action, ActionMicro, ActionMeso, ActionMacro, ActionRelation, Localization].each do |model|
