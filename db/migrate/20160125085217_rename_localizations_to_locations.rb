class RenameLocalizationsToLocations < ActiveRecord::Migration
  def change
    ...
    unless Rails.env.test?
      if (ActiveRecord::Base.connection.table_exists? 'act_localizations') && (File.exist? File.join('app', 'models', 'localizations', 'act_localization.rb'))
      ...
      if (ActiveRecord::Base.connection.table_exists? 'actor_localizations') && (File.exist? File.join('app', 'models', 'localizations', 'actor_localization.rb'))
